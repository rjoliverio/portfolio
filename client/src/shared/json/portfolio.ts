export const portfolio = [
  {
    ...
    title: 'GTrack Web',
    description:
      'GTrack Web is a platform part of the GTrack application which is a web and mobile based waste collection system built for the residents of Poblacion, Compostela, Cebu.',
  ...
  },
  {
    ...
    title: 'GTrack Mobile',
    description:
      'GTrack Mobile is the mobile counterpart of the GTrack application built with React Native and deployed on Google Play Store which provides services for the residents and drivers of the SWM Department.',
  ...
  },
  {
    ...
    description:
      'Built with Next.js TypeScript and TailwindCSS, Instagram Clone is a personal practice project built by yours truly in order to hone and improve my frontend skills.',
  ...
  },
  {
    ...
    title: 'Sun* HRIS',
    description:
      'HRIS is an internal simulation project for the admin team of Sun Asterisk PH that aims to help and ease admin operations.',
